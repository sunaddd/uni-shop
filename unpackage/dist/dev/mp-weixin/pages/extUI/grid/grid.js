...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return common_vendor.e({
    ...
    b: common_vendor.f(4, (item, index, i0) => {
      return {
        a: "19d54b73-4-" + i0 + "," + ("19d54b73-3-" + i0),
        b: index,
        c: "19d54b73-3-" + i0 + ",19d54b73-2",
        d: common_vendor.p({
          index
        })
      };
    ...
    g: common_vendor.f(8, (item, index, i0) => {
      return {
        a: "19d54b73-8-" + i0 + "," + ("19d54b73-7-" + i0),
        b: index,
        c: "19d54b73-7-" + i0 + ",19d54b73-6",
        d: common_vendor.p({
          index
        })
      };
    ...
    D: common_vendor.f($data.list, (item, index, i0) => {
      return common_vendor.e({
        ...
        d: "19d54b73-22-" + i0 + "," + ("19d54b73-21-" + i0),
        e: common_vendor.p({
          text: item.badge,
          type: item.type
        })
...
const MiniProgramPage = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["render", _sfc_render], ["__file", "D:/hbuilder/online-shop/online-shop/pages/extUI/grid/grid.nvue"]]);
