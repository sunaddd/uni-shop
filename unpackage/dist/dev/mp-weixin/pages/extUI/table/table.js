  ...
  return {
    ...
    e: common_vendor.f($data.tableData, (item, index, i0) => {
      return {
        ...
        b: "4a4306e9-7-" + i0 + "," + ("4a4306e9-6-" + i0),
        c: common_vendor.t(item.name),
        d: "4a4306e9-8-" + i0 + "," + ("4a4306e9-6-" + i0),
        e: common_vendor.t(item.address),
        f: "4a4306e9-9-" + i0 + "," + ("4a4306e9-6-" + i0),
        g: "4a4306e9-10-" + i0 + "," + ("4a4306e9-6-" + i0),
        h: index,
        i: "4a4306e9-6-" + i0 + ",4a4306e9-0"
      };
    }),
    f: common_vendor.p({
      align: "center"
    }),
    g: common_vendor.sr("table", "4a4306e9-0"),
...
const MiniProgramPage = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["render", _sfc_render], ["__file", "D:/hbuilder/online-shop/online-shop/pages/extUI/table/table.vue"]]);
