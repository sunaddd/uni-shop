...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return {
    ...
    A: common_vendor.sr("baseForm", "9b8f6c2a-2,9b8f6c2a-1"),
    B: common_vendor.p({
    ...
    L: common_vendor.sr("baseForm", "9b8f6c2a-21,9b8f6c2a-19"),
    M: common_vendor.p({
    ...
    X: common_vendor.sr("valiForm", "9b8f6c2a-27,9b8f6c2a-26"),
    Y: common_vendor.p({
      rules: $data.rules,
    ...
    ak: common_vendor.sr("customForm", "9b8f6c2a-35,9b8f6c2a-34"),
    al: common_vendor.p({
    ...
    ar: common_vendor.f($data.dynamicFormData.domains, (item, index, i0) => {
      return {
        a: "9b8f6c2a-47-" + i0 + "," + ("9b8f6c2a-46-" + i0),
    ...
    as: common_vendor.sr("dynamicForm", "9b8f6c2a-43,9b8f6c2a-42"),
    at: common_vendor.p({
...
const MiniProgramPage = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["render", _sfc_render], ["__file", "D:/hbuilder/online-shop/online-shop/pages/extUI/forms/forms.vue"]]);
